...
namespace animales.model.tipoAnimal
{
    internal class Aquatic : Animal
    {
        ...
        public Aquatic(string nameSpecie, decimal weigth, int age, IDiet diet) : base(nameSpecie, weigth, age, diet)
        {
            Id = ++globalCount;
        ...
        {
            return $"Id:{Id}, tipo de animal: Acuatico, nombre de especie: {NameSpecie}, peso: {Weight}, edad: {Age}, {Diet}";
        }
    }
}
